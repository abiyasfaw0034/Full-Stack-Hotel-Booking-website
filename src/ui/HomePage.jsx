...
// max-w-7xl mx-auto my-4 px-4 sm:px-6 lg:px-8
function HomePage() {
  const { currentUser } = useAuth();

  return (
    <>
      <div className="max-w-7xl mx-auto mb-4 mt-[15dvh] px-4 sm:px-6 lg:px-8 text-black dark:text-white bg-white dark:bg-black">
        {/* Search Bar */}
        <div className="flex items-center justify-between p-4 bg-white shadow-lg rounded-full flex-wrap sm:flex-nowrap">
          <div className="flex flex-col px-4 sm:w-auto">
            <label className="text-md font-semibold">Where</label>
            <input
              type="text"
              placeholder="Search destinations"
              className="focus:outline-none outline-none transition-transform duration-300 ease-in-out focus:scale-105"
            />
          </div>
